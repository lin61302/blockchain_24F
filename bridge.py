        ...
        try:
            ...
            for evt in events:
                ...
                try:
                    ...
                    txn = contract_other.functions.wrap(
                        token,
                        recipient,
                        amount
                    ).build_transaction({
                        'chainId': w3_other.eth.chain_id,
                        'gas': 500000,  # Using fixed gas as fallback
                        'maxFeePerGas': w3_other.eth.gas_price,
                        'maxPriorityFeePerGas': w3_other.eth.gas_price,
                        'nonce': nonce,
