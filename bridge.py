...
def scanBlocks(chain):
    ...
    # Use your address for WARDEN operations
    WARDEN = "0x634D745F4f3d26759Dd6836Ba25B16Ba3050d3D6"
    warden_key = source_info.get('private_key')
        ...
        try:
            ...
            for evt in unwraps:
                try:
                    ...
                    # Call withdraw on source chain as WARDEN
